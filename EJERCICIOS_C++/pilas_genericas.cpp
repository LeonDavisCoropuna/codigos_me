...
int main(){
    Stack <int> a,b; //instanciamos dos objetos
    a.push(3); // ingresamos datos en a
    a.push(5);
    b.push(8); // ingresamos datos en b
    b.push(2);
    Stack <int> c= a+b; //instanciamos c que resulta de la suma de los objetos a y b
    cout<<"Elementos de c: ";
    c.print();
    cout<<"\nElemento top de a: ";
    cout<<a.top()<<endl; //retornamos el nodo mas reciente de a
